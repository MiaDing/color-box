window.requestAnimationFrame(function(){
    ...
    //             fun_self.game_manager = new GameManager(8, HTMLActuator, LocalStorageManager, ClickEvent, AudioManager);
    //         }, 3000);
    //     }
    // };
    this.game_manager = new GameManager(8, HTMLActuator, LocalStorageManager, ClickEvent, AudioManager);
});
